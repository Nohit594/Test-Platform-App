...
"[project]/Downloads/project/src/app/api/tests/[id]/submit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        const existingAttempt = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].attempt.findFirst({
            where: {
                userId: user.id,
                testId: id
            }
        ...
        // Calculate Score
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].test.findUnique({
            where: {
                id: id
            },
            include: {
        ...
        if (!test) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const attempt = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].attempt.create({
            data: {
                testId: id,
                userId: user.id,
                score,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f8ba985._.js.map