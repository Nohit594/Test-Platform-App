...
"[project]/Downloads/project/src/app/api/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                username
            }
        });
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.create({
            data: {
                name,
                username,
                password,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__581b270b._.js.map