...
"[project]/Downloads/project/src/app/api/tests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].test.create({
            data: {
...
async function GET(req) {
    ...
    try {
        ...
        const tests = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].test.findMany({
            where,
            orderBy: {
                createdAt: 'desc'
            },
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(tests);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5de1a8fe._.js.map