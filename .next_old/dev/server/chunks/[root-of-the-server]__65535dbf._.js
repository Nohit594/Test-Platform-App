...
"[project]/Downloads/project/src/app/api/admin/assignments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const operations = userIds.map((userId)=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].testAssignment.upsert({
                where: {
                    testId_userId: {
                        testId,
                        userId
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(operations);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
async function DELETE(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$project$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].testAssignment.delete({
            where: {
                testId_userId: {
                    testId,
                    userId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65535dbf._.js.map